...
namespace PrivateKeyParsers
{
    ...
    public class KeyFileParser
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KeyFileParser"/> class.
        /// </summary>
        /// <param name="keyBytes">Raw content of the key file. CONTENT STRING MUST BE TRIMMED BEFORE.<see cref="byte[]"/></param>
        ...
        ///  Parses the key file.
        /// </summary>
        /// <returns><see cref="RSAParameters"/> with parameter values read from the file.</returns>
